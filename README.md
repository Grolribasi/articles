...
В контексте сервиса продукт представляет объект, содержащий название и его версию, например, Web-клиент 5.5.16, за которым закреплен определенный идентификатор.
