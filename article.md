...
2. Если вы используете UI, производный от дефолтного, потребуется перенести все изменения из supplemental_ui в ваш основной. Ну или наоборот — из основного в supplemental. Это касается файлов в папке `supplemental-ui/partials`(.hbs). Следующие строки из supplemental_ui нужно будет добавить в основной: в файл `footer-scripts.hbs`:
...
Изменение последней секунды в CSS:
